...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
       ...
       // setDeleteByPrimaryKeyStatementId("deleteByPrimaryKey"); //$NON-NLS-1$ //FIXME yuzhou
        setDeleteByPrimaryKeyStatementId("delete"); //$NON-NLS-1$
        //setInsertStatementId("insert"); //$NON-NLS-1$ //FIXME yuzhou
       // setInsertSelectiveStatementId("insertSelective"); //$NON-NLS-1$ //FIXME yuzhou
        setInsertSelectiveStatementId("insert"); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByExample"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByExampleWithBLOBs"); //$NON-NLS-1$
        //setSelectByPrimaryKeyStatementId("selectByPrimaryKey"); //$NON-NLS-1$ //FIXME yuzhou
        ...
        //setUpdateByPrimaryKeyStatementId("updateByPrimaryKey"); //$NON-NLS-1$ //FIXME yuzhou
        //setUpdateByPrimaryKeySelectiveStatementId("updateByPrimaryKeySelective"); //$NON-NLS-1$ //FIXME yuzhou
    ...
    protected void calculateJavaClientAttributes() {
        ...
        sb.append("I"+domainName.substring(0, domainName.length()-2));
//        sb.append("Mapper"); //$NON-NLS-1$
    ...
    protected String calculateMyBatis3XmlMapperFileName() {
        StringBuilder sb = new StringBuilder();
        String domainName = fullyQualifiedTable.getDomainObjectName();
        sb.append(domainName.substring(0, domainName.length() - 2));
